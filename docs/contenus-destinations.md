...
## Gabarit technique (structure de page)

Chaque fiche suit la même **architecture** — mais jamais le même **texte**.

```
1. Sur-titre + H1 + chapô          → unique par pays
2. Bloc informations clés          → données de la base
3. Texte éditorial (2–3 §)         → unique par pays
4. Ce que nos clients y envoient   → unique par pays
5. Bon à savoir                    → unique par pays
6. Prochains départs               → dynamique
7. CTA
```

**Bloc informations clés** — alimenté par la base :
Ville d'arrivée · Point de retrait · Tarif au départ de France · Tarif retour · Délai indicatif · Fréquence des départs

---

# 1. Côte d'Ivoire — Abidjan

**Slug** : `/destinations/cote-divoire`
**Title SEO** : Envoi de colis France → Abidjan, Côte d'Ivoire | ENI Colis Services
**Meta description** : Expédiez vos colis vers Abidjan par groupage aérien. Tarif au kilo, devis sous 24 h sur photos, retrait à Abidjan. Départs réguliers depuis la France.

**Sur-titre**
CÔTE D'IVOIRE

**H1**
Envoyer un colis à Abidjan
...
**Informations clés**
- Ville d'arrivée : Abidjan
- Point de retrait : `[À COMPLÉTER]`
- Départ de France : 15 €/kg
- Retour vers la France : 12 €/kg
- Délai indicatif : `[À COMPLÉTER]`
- Fréquence des départs : départs hebdomadaires
...
**Ce que nos clients envoient vers Abidjan**
...
**CTA**
Demander un devis pour Abidjan

---

# 2. Bénin — Cotonou

**Slug** : `/destinations/benin`
**Title SEO** : Envoi de colis France → Cotonou, Bénin | ENI Colis Services
**Meta description** : Colis vers Cotonou par fret aérien groupé. Prix ferme sous 24 h après envoi de photos. Point de retrait à Cotonou, tarif au kilo.

**Sur-titre**
BÉNIN

**H1**
Envoyer un colis à Cotonou
...
**Ce que nos clients envoient vers Cotonou**
...
**CTA**
Demander un devis pour Cotonou

---

# 3. Guinée — Conakry

**Slug** : `/destinations/guinee`
**Title SEO** : Envoi de colis France → Conakry, Guinée | ENI Colis Services
**Meta description** : Expédiez vers Conakry par groupage aérien. Devis chiffré sous 24 h, tarif au kilo, retrait à Conakry. Aller et retour assurés.

**Sur-titre**
GUINÉE

**H1**
Envoyer un colis à Conakry
...
**Ce que nos clients envoient vers Conakry**
...
**CTA**
Demander un devis pour Conakry

---

# 4. Mali — Bamako

**Slug** : `/destinations/mali`
**Title SEO** : Envoi de colis France → Bamako, Mali | ENI Colis Services
**Meta description** : Colis vers Bamako par fret aérien. Prix ferme après examen des photos, tarif au kilo, point de retrait à Bamako.

**Sur-titre**
MALI

**H1**
Envoyer un colis à Bamako
...
**Ce que nos clients envoient vers Bamako**
...
**CTA**
Demander un devis pour Bamako

---

# 5. Sénégal — Dakar

**Slug** : `/destinations/senegal`
**Title SEO** : Envoi de colis France → Dakar, Sénégal — 12 €/kg | ENI Colis Services
**Meta description** : Notre tarif le plus bas : 12 €/kg vers Dakar, dans les deux sens. Devis sous 24 h sur photos, retrait à Dakar.

**Sur-titre**
SÉNÉGAL

**H1**
Envoyer un colis à Dakar
...
**Informations clés**
- Ville d'arrivée : Dakar
- Point de retrait : `[À COMPLÉTER]`
- Départ de France : 12 €/kg
- Retour vers la France : 12 €/kg
- Délai indicatif : `[À COMPLÉTER]`
- Fréquence des départs : départs hebdomadaires
...
**Ce que nos clients envoient vers Dakar**
...
**H1**
Envoyer un colis à Brazzaville
...
**Informations clés**
- Ville d'arrivée : Brazzaville
- Point de retrait : `[À COMPLÉTER]`
- Départ de France : 20 €/kg
- Retour vers la France : 20 €/kg
- Délai indicatif : `[À COMPLÉTER]`
- Fréquence des départs : départs hebdomadaires
...
**Ce que nos clients envoient vers Brazzaville**
...
**CTA**
Demander un devis pour Brazzaville
...
**Meta description** : Colis vers Kinshasa par fret aérien groupé. Prix ferme sous 24 h après photos, point de retrait à Kinshasa.

**Sur-titre**
RÉPUBLIQUE DÉMOCRATIQUE DU CONGO

**H1**
Envoyer un colis à Kinshasa
...
**Informations clés**
- Ville d'arrivée : Kinshasa
- Point de retrait : `[À COMPLÉTER]`
- Départ de France : 15 €/kg
- Retour vers la France : 15 €/kg
- Délai indicatif : `[À COMPLÉTER]`
- Fréquence des départs : départs hebdomadaires
...
**Ce que nos clients envoient vers Kinshasa**
...
**CTA**
Demander un devis pour Kinshasa

---

# 8. États-Unis — New York

**Slug** : `/destinations/new-york`
**Title SEO** : Envoi de colis Abidjan ↔ New York | ENI Colis Services
**Meta description** : Liaison directe entre Abidjan et New York, dans les deux sens. 20 €/kg, devis sous 24 h. Une desserte rare sur ce corridor.
...
**Informations clés**
- Villes : Abidjan ↔ New York
- Point de retrait : `[À COMPLÉTER]`
- Abidjan → New York : 20 €/kg
- New York → Abidjan : 20 €/kg
- Délai indicatif : `[À COMPLÉTER]`
- Fréquence des départs : départs hebdomadaires
...
**Ce que nos clients envoient sur cette liaison**
...
**Depuis la France vers les États-Unis**
...
**CTA**
Demander un devis pour cette liaison

---

# Page index des destinations

**Slug** : `/destinations`
**Title SEO** : Nos destinations — Afrique de l'Ouest, Afrique centrale, New York | ENI Colis Services
**Meta description** : Sept pays d'Afrique et New York. Tarifs au kilo, départs réguliers, devis sous 24 h sur photos.
...
**Chapô**
Nous desservons sept pays d'Afrique de l'Ouest et centrale, ainsi que New York. Chaque destination a son tarif, son délai et son point de retrait. Tous nos envois fonctionnent dans les deux sens.

**Texte sous la grille**

Nos tarifs varient de 12 à 20 €/kg selon la destination et le sens de l'envoi. Cette différence tient à la fréquence des liaisons aériennes : plus une destination est desservie, plus la capacité en soute est disponible, et plus le tarif au kilo est bas.

Le montant indiqué sur chaque fiche est un tarif d'entrée pour un colis standard. Le prix exact de votre envoi dépend du poids, de l'encombrement et de la nature du contenu — il vous est confirmé par devis, sous 24 heures, après examen des photos.
...
## Récapitulatif — angle éditorial par fiche

| Destination | Angle retenu | Ce qui la rend unique |
|---|---|---|
| Abidjan | Notre destination principale | Fréquence des rotations, porte d'entrée vers New York |
| Cotonou | Commerce et revente | Confusion Porto-Novo/Cotonou, envois professionnels |
| Conakry | Le groupage expliqué | Rotations moins denses, importance du calendrier |
| Bamako | Pays enclavé | Pourquoi l'aérien, importance du volume |
| Dakar | Le tarif le plus bas | Symétrie aller/retour, densité du trafic |
| Brazzaville | Ne pas confondre les deux Congos | Partenariat, coût de l'Afrique centrale |
| Kinshasa | Pourquoi moins cher que Brazzaville | Volume de trafic, extension possible vers Lubumbashi |
| New York | Notre liaison rare | Alternative à l'express, formalités douanières |

Aucune de ces huit fiches ne partage de paragraphe, d'accroche ou de structure argumentative avec une autre. C'est cette diversité qui protège le référencement du site.

---

## Placeholders à compléter avant mise en ligne

| Information | Destinations concernées |
|---|---|
| Points de retrait (adresse, contact, horaires) | Les 8 |
| Délais indicatifs réels | Les 8 |
